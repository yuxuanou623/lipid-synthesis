...
def lipid_construction(list_of_reactants):
    nmt_pred = reaction_predictors.OpenNMTServerPredictor(server_address = 'http://localhost:9000/translator/translate')
...
if __name__ == '__main__':
    ...
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/sample3e5_0-COOH2-OH1-N_one_tail_purchasable_3.csv'
    n = 100000
