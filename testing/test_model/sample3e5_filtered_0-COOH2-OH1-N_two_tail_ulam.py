...
def lipid_construction(list_of_reactants):
    nmt_pred = reaction_predictors.OpenNMTServerPredictor(server_address = 'http://localhost:7000/translator/translate')
...
def main(input_head_path, input_tail_path, output_lipid_path, n):
    ...
    for i in tqdm(range(n)):
        ...
        list_of_reactants[i] = multiset.FrozenMultiset([selected_head.iloc[i]['2'], selected_tail.iloc[i]['Tails']])
...
if __name__ == '__main__':
    input_head_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/onetaillipid/sample3e5_0-COOH2-OH1-N_one_tail_lipid.csv'
    input_tail_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/purchasable_tails.csv'
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/sample3e5_0-COOH2-OH1-N_two_tails_lipid_1.csv'
    n = 150000
