...
if __name__ == '__main__':
    input_head_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/filtered_0-COOH2-OH1-N.csv'
    input_tail_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/purchasable_tails.csv'
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/sample3e5_0-COOH2-OH1-N_one_tail_purchasable_1.csv'
    n = 100000
