...
def main(input_head_path, input_tail_path, output_lipid_path, n):
    ...
    for i in tqdm(range(n)):
        ...
        list_of_reactants[i] = multiset.FrozenMultiset([selected_head.iloc[i]['ip2'], selected_tail.iloc[i]['SMILES']])
...
if __name__ == '__main__':
    input_head_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/smiles_index_new_twotail.csv'
    input_tail_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/smiles_index_new_tail.csv'
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/smiles_index_new_threetail.csv'
    n = 19198
