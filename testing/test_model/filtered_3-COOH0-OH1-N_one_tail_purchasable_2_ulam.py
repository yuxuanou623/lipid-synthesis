...
if __name__ == '__main__':
    input_head_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/filtered_3-COOH0-OH1-N.csv'
    input_tail_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/purchasable_tails.csv'
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/filtered_3-COOH0-OH1-N_one_tail_purchasable_3.csv'
    n = 300000
