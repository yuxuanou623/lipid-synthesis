...
def lipid_construction(list_of_reactants):
    nmt_pred = reaction_predictors.OpenNMTServerPredictor(server_address = 'http://localhost:6009/translator/translate')
...
if __name__ == '__main__':
    input_head_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/onetaillipid/sample3e5_2-COOH0-OH1-N_one_tail_lipid.csv'
    input_tail_path = '/scratch/yo279/Lipid_reaction_dataset_creation/Data/Data01/purchasable_tails.csv'
    output_lipid_path = '/scratch/yo279/Lipid_reaction_dataset_creation/SyntheticData/sample3e5_2-COOH0-OH1-N_two_tails_lipid.csv'
    n = 300000
