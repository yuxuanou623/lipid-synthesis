...
import sys
sys.path.append(os.path.abspath('/mnt/data/synthesis-dags'))
...
def main(params: Params):
    ...
    print(f"Number of trees in train set: {len(train_trees)}")
    ...
    # # Model
    model, collate_func, model_other_parts = doggen_utils.load_doggen_model(device=params.device, server_address='123',log_path_for_react_predict=params.log_for_reaction_predictor_path,data_version=params.dataversion,
...
# p.array(sequence_choices)       [0 2 0 1 0 0 1 2 1 9 5 1 8 6]                                                         | 0/1 [00:00<?, ?it/s]
# np.array(sequence_action_kinds) [0 1 0 1 0 1 0 2 2 3 2 0 3 2]
